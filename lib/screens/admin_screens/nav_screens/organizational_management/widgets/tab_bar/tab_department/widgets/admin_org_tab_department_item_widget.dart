...
class AdminOrgTabDepartmentItemWidget extends ConsumerStatefulWidget {
  const AdminOrgTabDepartmentItemWidget({super.key, required this.department});

  final Department department;

  @override
  _AdminOrgTabDepartmentItemWidgetState createState() => _AdminOrgTabDepartmentItemWidgetState();
}

class _AdminOrgTabDepartmentItemWidgetState extends ConsumerState<AdminOrgTabDepartmentItemWidget>
            ...
            Stack(
              ...
              children: [
                Container(
                  ...
                  child: Icon(FontAwesomeIcons.buildingUser,color: Colors.black.withOpacity(0.5)
                    ,size: 18,),
                ),
              ],
            ),
