                                          ...
                                          touchTooltipData: BarTouchTooltipData(
                                            ...
                                            getTooltipItem: (group, groupIndex, rod, rodIndex) {
                                              ...
                                              return BarTooltipItem(
                                                ...
                                                // 📝 ĐÃ SỬA: định dạng tooltip kiểu HH:mm
                                                const TextStyle(
                                                  color: Colors.white,
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 10,
                                        ...
                                        titlesData: FlTitlesData(
                                          bottomTitles: AxisTitles(
                                            sideTitles: SideTitles(
                                              reservedSize: 40,
                                              // Khoảng trống để hiển thị cả thứ và ngày.
                                              showTitles: true,
                                        ...
                                        barGroups: List.generate(data.length, (
                                          ...
                                          return BarChartGroupData(
                                            ...
                                            showingTooltipIndicators:
                                                minutes > 0
                                                ? [0]
                                                : [], // 📝 ĐÃ THÊM: chỉ hiện tooltip nếu có dữ liệu
                                          );
                                        }),
                                      ),
                                    ),
  ...
  List<Map<String, dynamic>> _buildChartData() {
    ...
    for (final work in works) {
      ...
      DateTime checkOut = checkIn.add(
        work.workTime!,
      ); // Hoặc dùng work.checkOutTime.toLocal() nếu có
